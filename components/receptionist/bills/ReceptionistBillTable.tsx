...
import { AdminBill, getAdminBillColumns } from "@/components/admin/bills/BillColumns";
import { BillDetailSheet } from "@/components/admin/bills/BillDetailSheet";
...
export function ReceptionistBillTable() {
  const {
    data: bills,
    loading,
    search,
    ...
    pagination,
    setPagination,
  } = useAdminFetch<AdminBill>({
    endpoint: "/api/receptionist/bills",
    dataKey: "bills",
  });
