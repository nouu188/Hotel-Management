...
import { cloudNineDetail } from "@/constants/wineDine";

export default function CloudNineRestaurantPage() {
  const detail = cloudNineDetail;
  ...
  return (
    <div className="flex-col justify-center lg:min-w-[1017px] w-full">
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6 mt-5 mb-8">
        ...
        {detail.reservationNote && (
          <div className="font-light text-[14px]">
            <h2 className="font-medium text-base mb-2">Reservations</h2>
            <p>{detail.reservationNote}</p>
          </div>
        )}
      </section>
    </div>
